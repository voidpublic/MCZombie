    ...
    public class CmdBanip : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (p != null)
            {
                ...
                Player.GlobalMessage("Someone was &8ip-banned" + Server.DefaultColor + " by " + p.color + p.name + Server.DefaultColor + ".");
                Player.GlobalMessageOps(message + " was &8ip-banned" + Server.DefaultColor + " by " + p.color + p.name + Server.DefaultColor + ".");
            }
            else
            {
                //Server.IRC.Say(message.ToLower() + " was ip-banned by console.");
                Server.s.Log("IP-BANNED: " + message.ToLower() + " by console.");
                Player.GlobalMessage("Someone was &8ip-banned" + Server.DefaultColor + " by console.");
                Player.GlobalMessageOps(message + " was &8ip-banned" + Server.DefaultColor + " by console.");
            }
