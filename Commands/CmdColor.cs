        ...
        public override void Use(Player p, string message)
        {
            ...
            if (pos != -1)
            {
                ...
                if (message.Substring(pos + 1) == "del")
                {
                    ...
                    Database.executeQuery("UPDATE Players SET color = '' WHERE name = @Name");Player.GlobalChat(who, who.color + "*" + Name(who.name) + " color reverted to " + who.group.color + "their group's default" + Server.DefaultColor + ".", false);
