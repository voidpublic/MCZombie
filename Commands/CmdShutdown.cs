...
namespace MCForge.Commands
{
    ...
    public class CmdShutdown : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (message == "") { message = "Server is going to restart in " + secTime + " seconds"; }
            else
            {
            ...
            if (shutdown)
            {
                ...
                {
                    if (!File.Exists(file)) { Player.GlobalMessage("%4Server restart in " + t + " seconds"); Server.s.Log("Server restart in " + t + " seconds"); Thread.Sleep(1000); }
