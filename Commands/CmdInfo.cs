    ...
    public class CmdInfo : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            else
            {
                ...
                Player.SendMessage(p, "This server is based on &bMCForge");
                Player.SendMessage(p, "MCForge version: &b5.5.0.1");
                Player.SendMessage(p, "The developer of ZombieSurvival is &bvoid_public");
                Player.SendMessage(p, "Zombiesurvival version: &b"+System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString());
                ...
                if (up.Minutes == 1) upTime += up.Minutes + " and minute ";
