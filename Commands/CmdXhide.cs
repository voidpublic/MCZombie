    ...
    public class CmdXhide : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (p.hidden)
            {
                ...
                if (!p.adminchat) Command.all.Find("adminchat").Use(p, "");

            }
            else
            {
                Player.GlobalMessageAdmins("To Admins -" + p.color + p.name + "-" + Server.DefaultColor + " is now &8visible" + Server.DefaultColor + ".");
